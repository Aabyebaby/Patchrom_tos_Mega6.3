...
.method static synthetic access$11500(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$UserAuthorizingJoinState;
    .locals 1
    .param p0, "x0"    # Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
...
.method private addLocalService(Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceInfo;)Z
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;->access$12800(Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;)Ljava/util/List;
...
.method private addServiceRequest(Landroid/os/Messenger;Landroid/net/wifi/p2p/nsd/WifiP2pServiceRequest;)Z
    ...
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12404(Landroid/net/wifi/p2p/WifiP2pService;)B

    .line 2793
    iget-object v2, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->this$0:Landroid/net/wifi/p2p/WifiP2pService;

    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mServiceTransactionId:B
    invoke-static {v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12400(Landroid/net/wifi/p2p/WifiP2pService;)B
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;->access$12700(Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;)Landroid/util/SparseArray;
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mServiceTransactionId:B
    invoke-static {v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$12400(Landroid/net/wifi/p2p/WifiP2pService;)B
...
.method private clearClientDeadChannels()V
    ...
    invoke-static {v6}, Landroid/net/wifi/p2p/WifiP2pService;->access$12300(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/util/HashMap;
    ...
    invoke-static {v0}, Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;->access$12900(Landroid/net/wifi/p2p/WifiP2pService$ClientInfo;)Landroid/os/Messenger;
...
.method private clearLocalServices(Landroid/os/Messenger;)V
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mClientInfoList:Ljava/util/HashMap;
    invoke-static {v3}, Landroid/net/wifi/p2p/WifiP2pService;->access$12300(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/util/HashMap;
...
.method private clearServiceRequests(Landroid/os/Messenger;)V
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mClientInfoList:Ljava/util/HashMap;
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12300(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/util/HashMap;
...
.method private initializeP2pSettings()V
    ...
    invoke-static {v1, v2}, Landroid/net/wifi/p2p/WifiP2pService;->access$12402(Landroid/net/wifi/p2p/WifiP2pService;B)B
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12500(Landroid/net/wifi/p2p/WifiP2pService;)Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;
    ...
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$12200()Ljava/lang/Boolean;
...
.method private replyToMessage(Landroid/os/Message;I)V
    ...
    invoke-static {v1}, Landroid/net/wifi/p2p/WifiP2pService;->access$12600(Landroid/net/wifi/p2p/WifiP2pService;)Lcom/android/internal/util/AsyncChannel;
...
.method private sendServiceResponse(Landroid/net/wifi/p2p/nsd/WifiP2pServiceResponse;)V
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->mClientInfoList:Ljava/util/HashMap;
    invoke-static {v5}, Landroid/net/wifi/p2p/WifiP2pService;->access$12300(Landroid/net/wifi/p2p/WifiP2pService;)Ljava/util/HashMap;
...
.method private startDhcpServer(Ljava/lang/String;)V
    ...
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$12000()[Ljava/lang/String;
