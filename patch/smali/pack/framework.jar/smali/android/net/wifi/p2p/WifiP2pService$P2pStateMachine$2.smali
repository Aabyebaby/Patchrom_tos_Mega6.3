...
# direct methods
.method constructor <init>(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Ljava/lang/String;Ljava/lang/String;)V
    .locals 0
    ...
    iput-object p2, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$2;->val$tempDevAddress:Ljava/lang/String;

    iput-object p3, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$2;->val$tempPin:Ljava/lang/String;
...
.method public onClick(Landroid/content/DialogInterface;I)V
    ...
    invoke-static {v0, v1}, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;->access$5102(Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine;Landroid/net/wifi/p2p/WifiP2pConfig;)Landroid/net/wifi/p2p/WifiP2pConfig;
    ...
    iget-object v1, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$2;->val$tempDevAddress:Ljava/lang/String;
    ...
    iget-object v1, p0, Landroid/net/wifi/p2p/WifiP2pService$P2pStateMachine$2;->val$tempPin:Ljava/lang/String;
    ...
    # getter for: Landroid/net/wifi/p2p/WifiP2pService;->FORM_GROUP:Ljava/lang/Boolean;
    invoke-static {}, Landroid/net/wifi/p2p/WifiP2pService;->access$12100()Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v1, v2}, Landroid/net/wifi/WifiNative;->p2pConnect(Landroid/net/wifi/p2p/WifiP2pConfig;Z)Ljava/lang/String;
