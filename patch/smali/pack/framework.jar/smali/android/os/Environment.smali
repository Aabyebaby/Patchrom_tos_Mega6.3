...
.method private static getExternalAppsVolume()Landroid/os/storage/StorageVolume;
    .locals 10
    ...
    invoke-virtual {v5}, Landroid/os/storage/StorageVolume;->isExternalApps()Z
    ...
    const-string v9, "Found external apps volume: "
...
.method public static getExternalAppsVolumeDirectory()Ljava/io/File;
    .locals 3

    .prologue
    .line 350
    invoke-static {}, Landroid/os/Environment;->getExternalAppsVolume()Landroid/os/storage/StorageVolume;
...
.method public static getExternalAppsVolumeState()Ljava/lang/String;
    .locals 5
    ...
    const-string v4, "Failed to read external SD state; assuming REMOVED: "
...
.method public static isExternalAppsAvailableAndMounted()Z
    .locals 5
    ...
    .line 311
    invoke-static {}, Landroid/os/Environment;->getExternalAppsVolumeState()Ljava/lang/String;
    ...
    const-string v3, "/data/system/no-external-apps"
    ...
    const-string v4, "Application moving was explicitly disabled"
    ...
    const-string v4, "External apps volume is NOT available"
